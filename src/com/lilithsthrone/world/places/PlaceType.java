...
public class PlaceType {
	...
	public static final AbstractPlaceType MUSEUM_ENTRANCE = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.PERSON, PopulationDensity.FEW, Map.of(Subspecies.HUMAN,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initItemsPersistInTile()
	.initWeatherImmune();
	...
	public static final AbstractPlaceType MUSEUM_CROWDS = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.CROWD, PopulationDensity.DENSE, Map.of(Subspecies.HUMAN,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initItemsPersistInTile()
	.initWeatherImmune();
	...
	public static final AbstractPlaceType DOMINION_PLAZA = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			...
			if(Main.game.getCurrentWeather()==Weather.MAGIC_STORM) {
				...
				pop.add(new Population(true, PopulationType.CENTAUR_CARTS, PopulationDensity.NUMEROUS, Map.of(Subspecies.CENTAUR,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
	...
	public static final AbstractPlaceType DOMINION_STREET = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.getCurrentWeather()!=Weather.MAGIC_STORM) {
				return List.of(
					new Population(true, PopulationType.CROWD, PopulationDensity.DENSE, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)),
					new Population(false, PopulationType.ENFORCER, PopulationDensity.OCCASIONAL, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true, Subspecies.HUMAN)),
					new Population(true, PopulationType.CENTAUR_CARTS, PopulationDensity.NUMEROUS, Map.of(Subspecies.CENTAUR,SubspeciesSpawnRarity.FOUR_COMMON)));
			} else {
				return List.of();
			}
		}
	...
	public static final AbstractPlaceType DOMINION_DEMON_HOME_DADDY = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.getCharactersPresent().contains(Main.game.getNpc(Daddy.class))) {
				return List.of(new Population(true, PopulationType.DINER, PopulationDensity.NUMEROUS, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
			}
			return DOMINION_PLAZA.getPopulation();
		}
	}.initMapBackgroundColour(PresetColour.MAP_BACKGROUND_PINK);
	...
	public static final AbstractPlaceType DOMINION_BACK_ALLEYS_SAFE = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			...
			return List.of(new Population(true, PopulationType.PERSON, PopulationDensity.FEW, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)),
	...
	public static final AbstractPlaceType ENFORCER_HQ_CORRIDOR = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.ENFORCER, PopulationDensity.SEVERAL, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true, Subspecies.HUMAN)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType ENFORCER_HQ_REQUISITIONS = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(!Main.game.getCharactersPresent(Main.game.getWorlds().get(WorldType.ENFORCER_HQ).getCell(ENFORCER_HQ_REQUISITIONS)).contains(Main.game.getNpc(Wes.class))
				...
				return List.of(new Population(false, PopulationType.ENFORCER, PopulationDensity.ONE, Map.of(Subspecies.DOG_MORPH_GERMAN_SHEPHERD,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
	...
	public static final AbstractPlaceType CITY_HALL_CORRIDOR = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.OFFICE_WORKER, PopulationDensity.SEVERAL, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType CITY_HALL_ENTRANCE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.PERSON, PopulationDensity.SEVERAL, Subspecies.getDominionStormImmuneSpecies(true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType CITY_HALL_INFORMATION_DESK = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.PERSON, PopulationDensity.SEVERAL, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType CITY_HALL_WAITING_AREA = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.PERSON, PopulationDensity.NUMEROUS, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType HOME_IMPROVEMENTS_CORRIDOR = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.SHOPPER, PopulationDensity.SEVERAL, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType HOME_IMPROVEMENTS_SHELVING_PREMIUM = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.SHOPPER, PopulationDensity.FEW, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType HOME_IMPROVEMENTS_BUILDING_SUPPLIES = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.SHOPPER, PopulationDensity.COUPLE, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType DOMINION_EXPRESS_CORRIDOR = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.isExtendedWorkTime()) {
				return List.of(new Population(true, PopulationType.SLAVE, PopulationDensity.SEVERAL, Map.of(Subspecies.CENTAUR,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
			return List.of(new Population(true, PopulationType.SLAVE, PopulationDensity.COUPLE, Map.of(Subspecies.CENTAUR,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType DOMINION_EXPRESS_EXIT = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.isExtendedWorkTime()) {
				return List.of(new Population(true, PopulationType.RECEPTIONIST, PopulationDensity.FEW, Map.of(Subspecies.HORSE_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
			return List.of(new Population(false, PopulationType.RECEPTIONIST, PopulationDensity.ONE, Map.of(Subspecies.HORSE_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType DOMINION_EXPRESS_OFFICE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.OFFICE_WORKER, PopulationDensity.OCCASIONAL, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType DOMINION_EXPRESS_STABLES = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.SLAVE, PopulationDensity.NUMEROUS, Map.of(Subspecies.CENTAUR,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType HARPY_NESTS_WALKWAYS = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.getCurrentWeather() == Weather.MAGIC_STORM) {
				...
				return List.of(new Population(true, PopulationType.HARPY, PopulationDensity.NUMEROUS, Subspecies.getWorldSpecies(WorldType.HARPY_NEST, this, false, false)));
			}
		}
	}.initSexNotBlockedFromCharacterPresent();
	...
	public static final AbstractPlaceType HARPY_NESTS_ENTRANCE_ENFORCER_POST = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.ENFORCER, PopulationDensity.NUMEROUS, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true, Subspecies.HUMAN)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType LILAYA_HOME_ROOM_WINDOW_GROUND_FLOOR = new AbstractPlaceType(
		...
		public List<AbstractPlaceUpgrade> getStartingPlaceUpgrades() {
			return List.of(PlaceUpgrade.LILAYA_EMPTY_ROOM);
		}
		@Override
...
//		}
	...
	public static final AbstractPlaceType LILAYA_HOME_ROOM_PLAYER = new AbstractPlaceType(
			...
			null, "in your room"
				...
				@Override
				public List<AbstractPlaceUpgrade> getAvailablePlaceUpgrades(Set<AbstractPlaceUpgrade> upgrades) {
					return List.of(PlaceUpgrade.LILAYA_PLAYER_ROOM_BED);
				}
				@Override
				public boolean isAbleToBeUpgraded() {
					return true;
	...
	public static final AbstractPlaceType SHOPPING_ARCADE_GENERIC_SHOP = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.isExtendedWorkTime()) {
				return List.of(new Population(true, PopulationType.SHOPPER, PopulationDensity.NUMEROUS, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
			} else {
				return new ArrayList<>();
			}
		}
	...
	public static final AbstractPlaceType TEXTILE_WAREHOUSE_ENTRANCE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.RECEPTIONIST, PopulationDensity.ONE, Map.of(Subspecies.RABBIT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
		@Override
		public String getTooltipDescription() {
			if(Main.game.getPlayer().isQuestCompleted(QuestLine.RELATIONSHIP_NYAN_HELP)) {
	...
	public static final AbstractPlaceType TEXTILE_WAREHOUSE_ENCHANTING = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.TEXTILE_WORKER, PopulationDensity.NUMEROUS,
							Map.of(Subspecies.RABBIT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.CAT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.DOG_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.FOX_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.HORSE_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.COW_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.HUMAN,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType TEXTILE_WAREHOUSE_OVERSEER_STATION = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.getWorlds().get(WorldType.TEXTILES_WAREHOUSE).getCell(PlaceType.TEXTILE_WAREHOUSE_OFFICE).isTravelledTo()) {
				return List.of(new Population(false, PopulationType.TEXTILE_WORKER, PopulationDensity.ONE, Map.of(Subspecies.FOX_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
			} else {
				return super.getPopulation();
			}
		}
	...
	public static final AbstractPlaceType SLAVER_ALLEY_AUCTIONING_BLOCK = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.CROWD, PopulationDensity.DENSE, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune(Weather.MAGIC_STORM);
	...
	public static final AbstractPlaceType SLAVER_ALLEY_PUBLIC_STOCKS = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.CROWD, PopulationDensity.SPARSE, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
		}
	}.initWeatherImmune(Weather.MAGIC_STORM);
	...
	public static final AbstractPlaceType SLAVER_ALLEY_SLAVERY_ADMINISTRATION = new AbstractPlaceType(
		...
		@Override
		public List<AbstractPlaceUpgrade> getStartingPlaceUpgrades() {
			return List.of(PlaceUpgrade.SLAVERY_ADMINISTRATION_CELLS);
		}
	}.initWeatherImmune(Weather.MAGIC_STORM);
			...
			if(Main.game.isStarted()) {
				if(Main.game.getPlayer().isQuestProgressGreaterThan(QuestLine.ROMANCE_HELENA, Quest.ROMANCE_HELENA_6_ADVERTISING)) {
					if(Main.game.getNpc(Helena.class).getLocationPlace().getPlaceType()==PlaceType.SLAVER_ALLEY_SCARLETTS_SHOP) {
						return List.of(new Population(true, PopulationType.HARPY, PopulationDensity.SEVERAL, Subspecies.getWorldSpecies(WorldType.HARPY_NEST, this, false, false)),
						...
						return List.of(new Population(true, PopulationType.FAN, PopulationDensity.COUPLE, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
					}
					...
					if(Main.game.getNpc(Helena.class).getLocationPlace().getPlaceType()==PlaceType.SLAVER_ALLEY_SCARLETTS_SHOP) {
						return List.of(new Population(true, PopulationType.FAN, PopulationDensity.NUMEROUS, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
					} else {
						return List.of(new Population(true, PopulationType.FAN, PopulationDensity.COUPLE, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)));
					}
				}
	...
	public static final AbstractPlaceType SLAVER_ALLEY_ENTRANCE = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.PERSON, PopulationDensity.FEW, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true)),
					new Population(true, PopulationType.PRIVATE_SECURITY_GUARD, PopulationDensity.COUPLE, Map.of(Subspecies.HORSE_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune(Weather.MAGIC_STORM);
	...
	public static final AbstractPlaceType WATERING_HOLE_ENTRANCE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.CROWD, PopulationDensity.DENSE, Subspecies.getWorldSpecies(WorldType.NIGHTLIFE_CLUB, this, false)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType WATERING_HOLE_SEATING_AREA = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.CROWD, PopulationDensity.SPARSE, Subspecies.getWorldSpecies(WorldType.NIGHTLIFE_CLUB, this, false)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType WATERING_HOLE_VIP_AREA = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.VIP, PopulationDensity.SEVERAL,
					Map.of(Subspecies.getSubspeciesFromId("innoxia_panther_subspecies_lion"),SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.HORSE_MORPH_ZEBRA,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType WATERING_HOLE_TOILETS = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.PERSON, PopulationDensity.SEVERAL, Subspecies.getWorldSpecies(WorldType.NIGHTLIFE_CLUB, this, false)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType HELENA_APARTMENT_HALLWAY = new AbstractPlaceType(
			...
			@Override
			public List<Population> getPopulation() {
				return List.of(new Population(false, PopulationType.MAID, PopulationDensity.OCCASIONAL, Map.of(Subspecies.HARPY,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
		}.initWeatherImmune();
	...
	public static final AbstractPlaceType HELENA_APARTMENT_ENTRANCE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.MAID, PopulationDensity.ONE, Map.of(Subspecies.HARPY,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType HELENA_APARTMENT_KITCHEN = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(false, PopulationType.CHEF, PopulationDensity.ONE, Map.of(Subspecies.HARPY,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType HELENA_APARTMENT_LOUNGE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.MAID, PopulationDensity.COUPLE, Map.of(Subspecies.HARPY,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType SUBMISSION_ENTRANCE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.ENFORCER, PopulationDensity.NUMEROUS,
					Map.of(Subspecies.ALLIGATOR_MORPH,SubspeciesSpawnRarity.THREE_UNCOMMON,Subspecies.CAT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.DOG_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.FOX_MORPH,SubspeciesSpawnRarity.THREE_UNCOMMON,Subspecies.HORSE_MORPH,SubspeciesSpawnRarity.THREE_UNCOMMON,Subspecies.RABBIT_MORPH,SubspeciesSpawnRarity.THREE_UNCOMMON,Subspecies.RAT_MORPH,SubspeciesSpawnRarity.THREE_UNCOMMON,Subspecies.WOLF_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType SUBMISSION_LILIN_PALACE_GATE = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.GUARD, PopulationDensity.NUMEROUS,
					Map.of(Subspecies.HALF_DEMON,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initMapBackgroundColour(PresetColour.MAP_BACKGROUND_DARK)
	.initWeatherImmune()
	.initTeleportPermissions(TeleportPermissions.NONE);
	...
	public static final AbstractPlaceType FORTRESS_DEMON_ENTRANCE = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			...
			return List.of(new Population(true, PopulationType.GUARD, PopulationDensity.NUMEROUS,
					Map.of(Subspecies.IMP_ALPHA,SubspeciesSpawnRarity.TWO_RARE,Subspecies.IMP,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
		@Override
	...
	public static final AbstractPlaceType FORTRESS_DEMON_CELLS = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			...
			return List.of(new Population(true, PopulationType.GUARD, PopulationDensity.FEW,
					Map.of(Subspecies.IMP_ALPHA,SubspeciesSpawnRarity.TWO_RARE,Subspecies.IMP,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
		@Override
		public Darkness getDarkness() {
	...
	public static final AbstractPlaceType LYSSIETH_PALACE_CORRIDOR = new AbstractPlaceType(
		...
		@Override
		public List<Population> getPopulation() {
			return List.of(new Population(true, PopulationType.MAID, PopulationDensity.COUPLE,
					Map.of(Subspecies.HUMAN,SubspeciesSpawnRarity.TWO_RARE,Subspecies.HALF_DEMON,SubspeciesSpawnRarity.FOUR_COMMON)));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType LYSSIETH_PALACE_SIREN_OFFICE = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.getNpc(DarkSiren.class).getHomeWorldLocation()!=WorldType.LYSSIETH_PALACE) {
				return List.of(new Population(false, PopulationType.RECEPTIONIST, PopulationDensity.ONE,
						Map.of(Subspecies.HALF_DEMON,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
			return super.getPopulation();
		}
	...
	public static final AbstractPlaceType BAT_CAVERN_LIGHT = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(Main.game.getCharactersPresent().contains(Main.game.getNpc(Elle.class))) {
				return List.of(new Population(true, PopulationType.GANG_MEMBER, PopulationDensity.SEVERAL, Map.of(Subspecies.RAT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.ALLIGATOR_MORPH,SubspeciesSpawnRarity.FOUR_COMMON,Subspecies.DOG_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
			return super.getPopulation();
		}
	}.initDangerous()
	...
	public static final AbstractPlaceType GAMBLING_DEN_CORRIDOR = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			...
			return List.of(new Population(true, PopulationType.CROWD, PopulationDensity.SPARSE, popComponent));
		}
	}.initWeatherImmune();
	...
	public static final AbstractPlaceType RAT_WARRENS_DORMITORY_LEFT = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(!Main.game.getDialogueFlags().hasFlag(DialogueFlagValue.ratWarrensClearedLeft)) {
				if(Main.game.isExtendedWorkTime()) {
					return List.of(new Population(true, PopulationType.GANG_MEMBER, PopulationDensity.FEW, Map.of(Subspecies.RAT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
				} else {
					return List.of(new Population(true, PopulationType.GANG_MEMBER, PopulationDensity.SEVERAL, Map.of(Subspecies.RAT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
				}
			}
			return new ArrayList<>();
		}
		...
		public List<Population> getPopulation() {
			if(!Main.game.getDialogueFlags().hasFlag(DialogueFlagValue.ratWarrensClearedCentre)) {
				if(Main.game.isExtendedWorkTime()) {
					...
					return List.of(new Population(true, PopulationType.GANG_MEMBER, PopulationDensity.COUPLE, Map.of(Subspecies.RAT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
				}
			}
			return new ArrayList<>();
		}
	...
	public static final AbstractPlaceType RAT_WARRENS_VENGARS_HALL = new AbstractPlaceType(
		...
		public List<Population> getPopulation() {
			if(!Main.game.getDialogueFlags().hasFlag(DialogueFlagValue.ratWarrensClearedCentre)) {
				return List.of(new Population(true, PopulationType.GANG_MEMBER, PopulationDensity.NUMEROUS, Map.of(Subspecies.RAT_MORPH,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
			return new ArrayList<>();
		}
		@Override
	...
	public static final AbstractGlobalPlaceType WORLD_MAP_DOMINION = new AbstractGlobalPlaceType(
		...
		public List<Population> getPopulation() {
			...
			if(Main.game.getCurrentWeather()==Weather.MAGIC_STORM) {
				...
				pop.add(new Population(false, PopulationType.ENFORCER, PopulationDensity.OCCASIONAL, Subspecies.getWorldSpecies(WorldType.DOMINION, this, true, Subspecies.HUMAN)));
				pop.add(new Population(false, PopulationType.CENTAUR_CARTS, PopulationDensity.OCCASIONAL, Map.of(Subspecies.CENTAUR,SubspeciesSpawnRarity.FOUR_COMMON)));
			}
