...
public class ItemGeneration {
	...
	public AbstractItem generateFilledCondom(ItemType filledCondomType, Colour colour, GameCharacter character, Fluid cum, int millilitres) {
		return new AbstractFilledCondom(filledCondomType, colour, character, cum, millilitres) {};
	}

	public AbstractItem generateFilledBreastPump(Colour colour, GameCharacter character, Fluid milk, int quantity) {
	...
	public AbstractWeapon generateWeapon(WeaponType wt, DamageType dt, List<Colour> colours) {
		...
		wt.applyGenerationColourReplacement(colours);
	...
	public AbstractClothing generateClothing(ClothingType clothingType, Colour primaryColour, Colour secondaryColour, Colour tertiaryColour, boolean allowRandomEnchantment) {
		...
		clothingType.applyGenerationColourReplacement(colours);
