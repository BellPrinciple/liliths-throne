...
public enum SpellUpgrade {
	...
	FIREBALL_1(true,
			...
			null, List.of("<b>5</b> [style.colourFire(Fire Damage)] per turn for [style.colourGood(2 turns)]")),
	FIREBALL_2(2,
			SpellSchool.FIRE,
			...
			null, List.of("Fires [style.colourExcellent(two)] Fireballs, doing <b>15</b> [style.colourFire(Fire Damage)] each")),
	FIREBALL_3(5,
			SpellSchool.FIRE,
			"fireball_burning_fury",
			"Burning Fury",
			"Fireball's twin comets now burn with an intense fury, doing considerably more damage.",
			null, List.of("Twin Comets now do <b>30</b> [style.colourFire(Fire Damage)] each")),
	...
	FLASH_1(true,
			...
			null, List.of("Flash now [style.colourExcellent(dazzles)] the target for [style.colourTerrible(-2)] [style.colourActionPoints(action points)]")),
	FLASH_2(5,
			SpellSchool.FIRE,
			"flash_arcing_flash",
			"Arcing Flash",
			"A secondary Flash arcs off from the first, seeking out another target to dazzle.",
			null, List.of("Fires [style.colourExcellent(two)] Flashes")),
	FLASH_3(3,
			SpellSchool.FIRE,
			...
			null, List.of("[style.colourExcellent(Reduces)] base cost to [style.boldMana(25)] aura")),
	...
	CLOAK_OF_FLAMES_1(true,
			...
			null, List.of("Unarmed attacks deal +1 damage per caster level",
	...
	CLOAK_OF_FLAMES_2(1,
			...
			null, List.of("[style.colourExcellent(Gain)] +25 [style.boldFire(Fire Damage)]")),
	CLOAK_OF_FLAMES_3(2,
			SpellSchool.FIRE,
			...
			null, List.of("<b>Melee</b> or <b>unarmed</b> attackers take <b>5</b> [style.colourFire(Fire Damage)]")),
	...
	ELEMENTAL_FIRE_1(true,
			...
			null, List.of("[style.colourExcellent(All allies gain)] +20 [style.boldFire(Fire Damage)]")),
	ELEMENTAL_FIRE_2(5,
			SpellSchool.FIRE,
			...
			null, List.of("[style.colourTerrible(All enemies suffer)] -25 [style.boldLust("+Attribute.RESISTANCE_LUST.getName()+")]")),
	ELEMENTAL_FIRE_3A(5,
			SpellSchool.FIRE,
	...
	ICE_SHARD_1(true,
			...
			null, List.of("<b>-20</b> "+Attribute.SPELL_COST_MODIFIER.getColouredName("b")+" for [style.colourGood(3 turns)]")),
	ICE_SHARD_2(2,
			SpellSchool.WATER,
			"ice_shard_cold_snap",
			"Cold Snap",
			...
			null, List.of("Ice Shard [style.boldExcellent(critically hits)] targets affected by Freezing Fog")),
	ICE_SHARD_3(5,
			SpellSchool.WATER,
			...
			null, List.of("When Ice Shard [style.boldExcellent(critically hits)] a target affected by Freezing Fog, that target suffers [style.colourTerrible(-1)] [style.colourActionPoints(action points)]")),
	...
	RAIN_CLOUD_1(true,
			...
			null, List.of("Adds <b>-25</b> "+Attribute.RESISTANCE_ICE.getColouredName("b")+" to Rain Cloud's effects")),
	RAIN_CLOUD_2(3,
			SpellSchool.WATER,
			"rain_cloud_downpour",
			"Downpour",
			"Sheets of torrential arcane rain sweep into the target's eyes, causing them to miss the occasional attack.",
			null, List.of("Adds <b>-5</b> "+Attribute.ENERGY_SHIELDING.getColouredName("b")+" to Rain Cloud's effects")),
	RAIN_CLOUD_3(5,
			SpellSchool.WATER,
			...
			null, List.of("If Rain Cloud's target is hit by a critical attack, the duration is set to [style.colourGood(6 turns)], and "+Attribute.SPELL_COST_MODIFIER.getColouredName("b")+" debuff is increased to -50")),
	...
	SOOTHING_WATERS_1_CLEAN(true,
			...
			null, List.of("Soothing Waters [style.boldAqua(cleans all worn clothing)]",
	...
	SOOTHING_WATERS_2_CLEAN(true,
			...
			null, List.of("Soothing Waters [style.boldAqua(drains [style.fluid(250)] of fluid from all orifices)]")),
	SOOTHING_WATERS_1(true,
			...
			null, List.of("Soothing Waters [style.boldExcellent(additionally)] restores <b>20%</b> "+Attribute.MANA_MAXIMUM.getColouredName("b"))),
	SOOTHING_WATERS_2(10,
			...
			null, List.of("Soothing Waters' restoration [style.boldExcellent(increased)] to <b>40%</b> "+Attribute.HEALTH_MAXIMUM.getColouredName("b"))),
	SOOTHING_WATERS_3(10,
			...
			null, List.of("Soothing Waters heals [style.boldExcellent(all allies)] for <b>10%</b> "+Attribute.HEALTH_MAXIMUM.getColouredName("b")+" and <b>10%</b> "+Attribute.MANA_MAXIMUM.getColouredName("b"))),
	...
	ELEMENTAL_WATER_1(true,
			...
			null, List.of("[style.colourExcellent(All allies gain)] +20 [style.boldIce(Ice Damage)]")),
	ELEMENTAL_WATER_2(5,
			SpellSchool.WATER,
			...
			null, List.of("[style.colourExcellent(All allies gain)] +5 "+Attribute.RESISTANCE_LUST.getColouredName("b"))),
	...
	POISON_VAPOURS_1(true,
			...
			null, List.of("Poison Vapours additionally applies <b>-5</b> "+Attribute.ENERGY_SHIELDING.getColouredName("b"))),
	POISON_VAPOURS_2(5,
			SpellSchool.AIR,
			...
			null, List.of("Poison Vapours additionally drains <b>10</b> "+Attribute.MANA_MAXIMUM.getColouredName("b")+" per turn")),
	POISON_VAPOURS_3(2,
			SpellSchool.AIR,
			"poison_vapours_weakening_cloud",
			"Weakening Cloud",
			"Poison Vapours starts to seep into the target's body, significantly weakening their attacks.",
			null, List.of("Poison Vapours additionally applies <b>-15</b> "+Attribute.DAMAGE_PHYSICAL.getColouredName("b"),
	...
	VACUUM_1(true,
			...
			null, List.of("Vacuum additionally applies <b>-15</b> "+Attribute.CRITICAL_DAMAGE.getColouredName("b"),
	...
	VACUUM_2(2,
			...
			null, List.of("<b>10%</b> chance per turn of [style.boldExcellent(stripping)] clothing")),
	VACUUM_3(4,
			SpellSchool.AIR,
			"vacuum_total_void",
			"Total Void",
			"The strip chance from Suction is increased to 25%.",
			null, List.of("Suction's strip chance [style.boldExcellent(increased)] to <b>25%</b>")),
	...
	PROTECTIVE_GUSTS_1(true,
			...
			null, List.of("Protective Gusts buff increased to <b>+2</b> "+Attribute.ENERGY_SHIELDING.getColouredName("b"),
	...
	PROTECTIVE_GUSTS_2(1,
			...
			null, List.of("Protective Gusts buff increased to <b>+3</b> "+Attribute.ENERGY_SHIELDING.getColouredName("b"),
	...
	PROTECTIVE_GUSTS_3(2,
			...
			null, List.of("Protective Gusts now lasts for [style.boldGood(5 turns)]")),
	...
	ELEMENTAL_AIR_1(true,
			...
			null, List.of("[style.colourTerrible(All enemies suffer)] -5 "+Attribute.ENERGY_SHIELDING.getColouredName("b"))),
	ELEMENTAL_AIR_2(5,
			SpellSchool.AIR,
			...
			null, List.of("[style.colourExcellent(All allies gain)] +10 "+Attribute.DAMAGE_PHYSICAL.getColouredName("b"),
	...
	SLAM_1(true,
			...
			null, List.of("<b>-10</b> "+Attribute.ENERGY_SHIELDING.getColouredName("b")+" for [style.colourGood(2 turns)]")),
	SLAM_2(2,
			SpellSchool.EARTH,
			"slam_aftershock",
			"Aftershock",
			"Just as the tremors start to die away, a huge surge of force rises up out of the ground to hit the target.",
			null, List.of("Applies <b>5</b> "+Attribute.DAMAGE_PHYSICAL.getColouredName("b")+" as Ground Shake ends")),
	SLAM_3(5,
			SpellSchool.EARTH,
			"slam_earthquake",
			"Earthquake",
			"Slam impacts the ground so hard that all enemies suffer the effects of Ground Shake.",
			null, List.of("[style.colourExcellent(All enemies)] are affected by Ground Shake")),
	...
	TELEKENETIC_SHOWER_1(true,
			...
			null, List.of("Telekinetic Shower now lasts for [style.boldGood(6 turns)]")),
	TELEKENETIC_SHOWER_2(1,
			...
			null, List.of("Telekinetic Shower additionally applies <b>-20</b> "+Attribute.RESISTANCE_PHYSICAL.getColouredName("b"))),
	TELEKENETIC_SHOWER_3(10,
			...
			null, List.of("Telekinetic Shower damage [style.colourExcellent(doubled)] to <b>50</b> "+Attribute.DAMAGE_PHYSICAL.getColouredName("b")+" per turn")),
	...
	STONE_SHELL_1(true,
			...
			null, List.of("Stone Shell additionally applies <b>+2</b> "+Attribute.ENERGY_SHIELDING.getColouredName("b"))),
	STONE_SHELL_2(2,
			SpellSchool.EARTH,
			...
			null, List.of("Stone Shell's buff is increased to <b>+10</b> "+Attribute.RESISTANCE_PHYSICAL.getColouredName("b"))),
	STONE_SHELL_3(1,
			SpellSchool.EARTH,
			...
			null, List.of("[style.colourExcellent(All enemies)] take <b>10</b> "+Attribute.DAMAGE_PHYSICAL.getColouredName("b")+" when Stone Shell ends")),
	...
	ELEMENTAL_EARTH_1(true,
			...
			null, List.of("[style.colourExcellent(All allies gain)] +15 "+Attribute.DAMAGE_PHYSICAL.getColouredName("b"),
	...
	ELEMENTAL_EARTH_2(5,
			...
			null, List.of("[style.colourExcellent(All allies gain)] +10 "+Attribute.RESISTANCE_PHYSICAL.getColouredName("b"))),
	...
	ARCANE_AROUSAL_1(true,
			...
			null, List.of("Arcane Arousal damage [style.colourExcellent(doubled)] to <b>30</b> "+Attribute.DAMAGE_LUST.getColouredName("b"))),
	ARCANE_AROUSAL_2(2,
			SpellSchool.ARCANE,
			...
			null, List.of("Target [style.boldBad(suffers)] -15 "+Attribute.ENERGY_SHIELDING.getColouredName("b")+" for [style.boldGood(2 turns)]")),
	ARCANE_AROUSAL_3(2,
			SpellSchool.ARCANE,
			...
			null, List.of("Target [style.boldBad(additionally suffers)] -25 "+Attribute.RESISTANCE_LUST.getColouredName("b"),
	...
	TELEPATHIC_COMMUNICATION_1(true,
			...
			null, List.of("Start combat with Telepathic Communication [style.boldExcellent(already activated)]",
	...
	TELEPATHIC_COMMUNICATION_2(3,
			...
			null, List.of("Buff [style.colourExcellent(doubled)] to <b>30</b> "+Attribute.DAMAGE_LUST.getColouredName("b"))),
	TELEPATHIC_COMMUNICATION_3(3,
			...
			null, List.of("[style.boldLust(Seduce)] [style.boldExcellent(applies)] -25 "+Attribute.RESISTANCE_PHYSICAL.getColouredName("b")+" to the target for [style.boldGood(2 turns)]")),
	...
	ARCANE_CLOUD_1(true,
			...
			null, List.of("<b>5</b> "+Attribute.DAMAGE_LUST.getColouredName("b")+" per turn")),
	ARCANE_CLOUD_2(5,
			SpellSchool.ARCANE,
			...
			null, List.of(Attribute.DAMAGE_LUST.getColouredName("b")+" [style.boldExcellent(increased)] to <b>15</b> per turn")),
	ARCANE_CLOUD_3(10,
			SpellSchool.ARCANE,
			...
			null, List.of("[style.boldExcellent(All enemies)] suffer <b>15</b> "+Attribute.DAMAGE_LUST.getColouredName("b")+" per turn")),
	...
	CLEANSE_1(true,
			...
			null, List.of("Only [style.boldTerrible(negative)] effects are removed from [style.boldExcellent(allies)]",
	...
	CLEANSE_2(5,
			...
			null, List.of("+/-5 "+Attribute.RESISTANCE_PHYSICAL.getColouredName("b"),
	...
	CLEANSE_3(2,
			...
			null, List.of("Arcane Duality's duration increased to [style.boldGood(6 turns)]")),
	...
	STEAL_1(true,
			...
			null, List.of("Steal [style.boldExcellent(additionally)] can target outer layers of clothing")),
	STEAL_2(10,
			SpellSchool.ARCANE,
			"steal_disarm",
			"Disarm",
			"Steal is now powerful enough to teleport weapons right out of the target's hands.",
			null, List.of("Steal [style.boldExcellent(additionally)] can target equipped weapons")),
	STEAL_3A(5,
			SpellSchool.ARCANE,
			"steal_deep_reach",
			"Deep Reach",
			...
			null, List.of("Steal [style.boldExcellent(additionally)] can target any layer of clothing")),
	STEAL_3B(10,
			SpellSchool.ARCANE,
			...
			null, List.of("Steal [style.boldExcellent(prioritises)] target's clothing in groin slot")),
	...
	TELEPORT_1(true,
			...
			null, List.of("Deals <b>5</b> "+Attribute.DAMAGE_LUST.getColouredName("b")+" to a random enemy")),
	TELEPORT_2(15,
			SpellSchool.ARCANE,
			"teleport_mass_teleportation",
			"Mass Teleportation",
			"The caster is now able to apply Teleport to as many nearby people as they choose.",
			null, List.of("Teleport applied to [style.colourExcellent(all allies)] of target",
	...
	TELEPORT_3(10,
			...
			null, List.of("Teleport duration increased to [style.boldGood(2 turns)]",
	...
	LILITHS_COMMAND_1(true,
			...
			null, List.of("Success chance [style.colourExcellent(increased)] to 50%")),
	LILITHS_COMMAND_2(15,
			...
			null, List.of("Lilith's Command now [style.colourExcellent(affects demons)]",
	...
	LILITHS_COMMAND_3(20,
			...
			null, List.of("Success chance [style.colourExcellent(increased)] to 100%")),
	...
	ELEMENTAL_ARCANE_1(true,
			...
			null, List.of("[style.colourExcellent(All allies gain)] +15 "+Attribute.DAMAGE_LUST.getColouredName("b"))),
	ELEMENTAL_ARCANE_2(5,
			...
			null, List.of("[style.boldTerrible(All enemies suffer)] -15 "+Attribute.RESISTANCE_LUST.getColouredName("b"))),
