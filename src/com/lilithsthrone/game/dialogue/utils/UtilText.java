...
//	private static List<GameCharacter> specialNPCList = new ArrayList<>();
	...
	private static Map<String, String> americanEnglishConversions = Map.<String,String>ofEntries(
			// -our to -or:
			entry("armour", "armor"),
			entry("armoury", "armory"),
			entry("behaviour", "behavior"),
			entry("candour", "candor"),
			entry("clamour", "clamor"),
			entry("colour", "color"),
			entry("demeanour", "demeanor"),
			entry("endeavour", "endeavor"),
			entry("favourite", "favorite"),
			entry("flavour", "flavor"),
			entry("glamour", "glamor"),
			entry("harbour", "harbor"),
			entry("honour", "honor"),
			entry("humour", "humor"),
			entry("labour", "labor"),
			entry("neighbour", "neighbor"),
			entry("odour", "odor"),
			entry("parlour", "parlor"),
			entry("rancour", "rancor"),
			entry("rigour", "rigor"),
			entry("rumour", "rumor"),
			entry("saviour", "savior"),
			entry("savour", "savor"),
			entry("savoury", "savory"),
			entry("splendour", "splendor"),
			entry("valour", "valor"),
			entry("vapour", "vapor"),
			entry("vigour", "vigor"),
			
			// -re to -er:
			entry("amphitheatre", "amphitheater"),
			entry("calibre", "caliber"),
			entry("centimetre", "centimeter"),
			entry("centre", "center"),
			entry("fibre", "fiber"),
			entry("kilometre", "kilometer"),
			entry("litre", "liter"),
			entry("louvre", "louver"),
			entry("lustre", "luster"),
			entry("manoeuvre", "maneuver"),
			entry("meagre", "meager"),
			entry("metre", "meter"),
			entry("millimetre", "millimeter"),
			entry("sabre", "saber"),
			entry("sceptre", "scepter"),
			entry("sombre", "somber"),
			entry("spectre", "specter"),
			entry("theatre", "theater"),

			// -ogue to -og:
			entry("analogue", "analog"),
			entry("dialogue", "dialog"),
			entry("catalogue", "catalog"),
//			entry("epilogue", "epilog"),
//			entry("monologue", "monolog"),
//			entry("prologue", "prolog"),
//			entry("travelogue", "travelog"),
			
			// -l endings are not doubled:
			entry("cancelled", "canceled"),
			entry("counsellor", "counselor"),
			entry("equalled", "equaled"),
			entry("fuelling", "fueling"),
			entry("fuelled", "fueled"),
			entry("grovelling", "groveling"),
			entry("jeweller", "jeweler"),
			entry("jewellery", "jewelery"),
			entry("levelled", "leveled"),
			entry("libelled", "libeled"),
			entry("marvellous", "marvelous"),
			entry("modelling", "modeling"),
			entry("panelled", "paneled"),
			entry("quarrelling", "quarreling"),
			entry("revelled", "reveled"),
			entry("woollen", "woolen"),

			// some -l words are doubled:
			entry("appal(^l)", "appall$1"),
			entry("distil(^l)", "distill$1"),
			entry("enrol(^l)", "enroll$1"),
			entry("enthral(^l)", "enthrall$1"),
			entry("fulfil(^l)", "fulfill$1"),
			entry("instil(^l)", "instill$1"),
			entry("skilful(^l)", "skillful$1"),
			entry("wilful(^l)", "willful$1"),

			// -ae and -oe words change to -e:
			entry("diarrhoea", "diarrhea"),
			entry("oestrogen", "estrogen"),
			entry("foetus", "fetus"),
			//entry("manoeuvre", "maneuver"),
			entry("mementoes", "mementos"),
			entry("anaemia", "anemia"),
			entry("caesarean", "cesarean"),
			entry("gynaecology", "gynecology"),
			entry("haemorrhage", "hemorrhage"),
			entry("leukaemia", "leukemia"),
			entry("palaeontology", "paleontology"),
			entry("paediatric", "pediatric"),

			// -ise words change to -ize:
			entry("apologise", "apologize"),
			entry("appetiser", "appetizer"),
			entry("authorise", "authorize"),
			entry("capitalise", "capitalize"),
			entry("characterise", "characterize"),
			entry("civilise", "civilize"),
			entry("colonise", "colonize"),
			entry("criticise", "criticize"),
			entry("dramatise", "dramatize"),
			entry("emphasise", "emphasize"),
			entry("equalise", "equalize"),
			entry("mobilise", "mobilize"),
			entry("naturalise", "naturalize"),
			entry("organise", "organize"),
			entry("popularise", "popularize"),
			entry("realise", "realize"),
			entry("recognise", "recognize"),
			entry("satirise", "satirize"),
			entry("standardise", "standardize"),
			entry("symbolise", "symbolize"),
			entry("vaporise", "vaporize"),
			entry("analyse", "analyze"),
			entry("paralyse", "paralyze"),

			// -ce words change to -se:
			entry("defence", "defense"),
			entry("defencive", "defensive"),
			entry("offence", "offense"),
			entry("offencive", "offensive"),
			entry("pretence", "pretense"),
			entry("licence", "license"),
			entry("practise", "practice"),
			...
			entry("mould", "mold"),
			entry("moult", "molt"),
			entry("smoulder", "smolder"),
			entry("programme", "program"),
			entry("cheque", "check"),
			entry("chequer", "checker"),
			entry("acknowledgement", "acknowledgment"),
			entry("ageing", "aging"),
			entry("judgement", "judgment"),
			entry("aluminium", "aluminum"),
			entry("axe", "ax"),
			entry("cosy", "cozy"),
			entry("kerb", "curb"),
			entry("furore", "furor"),
			entry("grey", "gray"),
			entry("carat", "karat"),
			entry("liquorice", "licorice"),
			entry("moustache", "mustache"),
			entry("nought", "naught"),
			entry("pyjamas", "pajamas"),
			entry("sceptic", "skeptic"),
			entry("phial", "vial"),
			entry("whisky", "whiskey"),
			entry("queue", "line")
			);
...
//		return "<span style='font-family:serif; font-weight:normal; font-size:1.25em;'>&#8734;</span>";
	...
	public static String parseFromXMLFile(String pathName, String tag, GameCharacter... specialNPCs) {
		return parseFromXMLFile(new ArrayList<>(), "res/txt/", pathName, tag, List.of(specialNPCs));
	}
	...
	public static String parseFromXMLFile(List<ParserTag> parserTags, String pathName, String tag, GameCharacter... specialNPCs) {
		return parseFromXMLFile(parserTags, "res/txt/", pathName, tag, List.of(specialNPCs));
	}
...
//				String rootElelemnt = doc.getDocumentElement().getTagName();
	...
	public static String runXmlTest(String pathName) {
		return runXmlTest(pathName, List.of(Main.game.getNpc(Lilaya.class),
...
//							System.out.println("noConditionalBrackets");
	...
	static{
		...
		commandsList.add(new ParserCommand(
				...
				true,
				"",
				"Returns the name of what kind of wall is in the character's area."){
			@Override
...
//					return character.getRelationshipStrTo(targetedCharacter);
		...
		commandsList.add(new ParserCommand(
				List.of("materialSkinAltAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialOrificeAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialOrificeAltAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialHairBodyAdjective",
		...
		commandsList.add(new ParserCommand(
				List.of("materialHairAltAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialFurAltAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialFeatherAdjective",
		...
		commandsList.add(new ParserCommand(
				List.of("materialFeatherAltAdjective",
		...
		commandsList.add(new ParserCommand(
				List.of("materialScaleAdjective",
		...
		commandsList.add(new ParserCommand(
				List.of("materialScaleAltAdjective",
		...
		commandsList.add(new ParserCommand(
				List.of("materialShellAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialShellAltAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialKeratinAdjective"),
				true,
				true,
				"",
		...
		commandsList.add(new ParserCommand(
				List.of("materialKeratinAltAdjective"),
				true,
				true,
				"",
			...
			public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
				if(Main.game.isInSex()) {
					...
					switch(Main.sex.getSexPace(character)) {
						case DOM_GENTLE:
							descriptors = List.of("gently", "softly", "lovingly");
							break;
						case DOM_NORMAL:
							descriptors = List.of("happily", "eagerly", "enthusiastically", "desperately");
							break;
						case DOM_ROUGH:
							descriptors = List.of("roughly", "forcefully", "violently", "dominantly");
							break;
						case SUB_EAGER:
							descriptors = List.of("happily", "eagerly", "enthusiastically", "desperately");
							break;
						case SUB_NORMAL:
							if(arguments!=null && !arguments.isEmpty()) {
								...
								descriptors = List.of("happily", "eagerly", "willingly"); // If start of sentence, need descriptor.
								break;
							} else {
								return "";
							}
						case SUB_RESISTING:
							descriptors = List.of("frantically", "desperately", "maniacally");
							break;
					}
		...
		for(Gender gender : Gender.values()) {
			commandsList.add(new ParserCommand(
					List.of(gender.getType()==PronounType.FEMININE
		...
		addStandardParsingCommands(
				List.of("anus", "asshole"),
				List.of("anuses", "assholes"),
				BodyPartType.ANUS);
		
		addStandardParsingCommands(
				List.of("breast", "tit", "boob", "chest"),
				List.of("breasts", "tits", "boobs"),
				BodyPartType.BREAST);

		addStandardParsingCommands(
				List.of("nipple", "teat"),
				List.of("nipples", "teats"),
				BodyPartType.NIPPLES);

		addStandardParsingCommands(
				List.of("milk"),
				List.of("milks"), // milks? Really?
				BodyPartType.MILK);
		
		addStandardParsingCommands(
				List.of("breastCrotch", "titCrotch", "boobCrotch", "crotchBreast", "crotchTit", "crotchBoob", "udder"),
				List.of("breastsCrotch", "titsCrotch", "boobsCrotch", "crotchBreasts", "crotchTits", "crotchBoobs", "udders"),
				BodyPartType.BREAST_CROTCH);

		addStandardParsingCommands(
				List.of("nippleCrotch", "teatCrotch", "crotchNipple", "crotchTeat", "udderTeat", "uddersTeat"),
				List.of("nipplesCrotch", "teatsCrotch", "crotchNipples", "crotchTeats", "udderTeats", "uddersTeats"),
				BodyPartType.NIPPLES_CROTCH);

		addStandardParsingCommands(
				List.of("milkCrotch", "crotchMilk", "udderMilk", "uddersMilk"),
				List.of("milksCrotch", "crotchMilks", "udderMilks", "uddersMilks"), // milks? Really?
		...
		addStandardParsingCommands(
				List.of("hair", "feather"),
				List.of("hairs", "feathers"),
				BodyPartType.HAIR);
		...
		addStandardParsingCommands(
				List.of("penis", "cock", "dick"),
				List.of("penises", "cocks", "dicks"),
				BodyPartType.PENIS);

		addStandardParsingCommands(
				List.of("secondPenis", "secondCock", "secondDick", "penis2", "cock2", "dick2"),
				List.of("secondPenises", "secondCocks", "secondDicks", "penises2", "cocks2", "dicks2"),
				BodyPartType.SECOND_PENIS);
		
		addStandardParsingCommands(
				List.of("testicle", "ball"),
				List.of("testicles", "balls"),
		...
		addStandardParsingCommands(
				List.of("skin"), // Will usually return the plural anyway...
				List.of("skinPlural"),
				BodyPartType.SKIN);
		...
		addStandardParsingCommands(
				List.of("clit", "clitoris"),
				List.of("clits", "clitorises"),
				BodyPartType.CLIT);
		
		addStandardParsingCommands(
				List.of("vagina", "pussy", "cunt"),
				List.of("vaginas", "pussies", "cunts"),
				BodyPartType.VAGINA);

		addStandardParsingCommands(
				List.of("girlcum", "gcum"),
				List.of("girlcums", "gcums"),
		...
		commandsList.add(new ParserCommand(
				List.of("penisUrethraElasticity",
		...
		commandsList.add(new ParserCommand(
				List.of("penisUrethraPlasticity",
		...
		commandsList.add(new ParserCommand(
				List.of("tentacleBaseCircumference"),
				true,
				true,
				"(pluralUnits)",
		...
		commandsList.add(new ParserCommand(
				List.of("tentacleTipCircumference"),
				true,
				true,
				"(pluralUnits)",
		...
		commandsList.add(new ParserCommand(
				List.of("tentaclePenetrationLength",
		...
		commandsList.add(new ParserCommand(
				List.of("pussyUrethraElasticity",
		...
		commandsList.add(new ParserCommand(
				List.of("pussyUrethraPlasticity",
		...
		commandsList.add(new ParserCommand(
			...
			@Override
			public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
				List<String> descriptors = List.of(character.getVaginaLabiaSize().getName());
		...
		commandsList.add(new ParserCommand(
				List.of("toyVaginaCircumference",
		...
		commandsList.add(new ParserCommand(
				List.of("spinneretFullDescription"),
				true,
				true,
		...
		commandsList.add(new ParserCommand(
				List.of("spinneretColourPrimary",
		...
		commandsList.add(new ParserCommand(
				List.of("spinneretColourSecondary",
