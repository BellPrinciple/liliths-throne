...
public interface Quest {
	...
	default QuestType getQuestType() {
...
//					+ " You could either offer yourself, or, if you own any slaves, offer one of those to Arthur instead.";
	...
	Special(QuestType questType, int level, int experienceReward) {
	...
	Special MAIN_PROLOGUE = Special.MAIN_PROLOGUE;
	Special MAIN_1_A_LILAYAS_TESTS = Special.MAIN_1_A_LILAYAS_TESTS;
	Special MAIN_1_B_DEMON_HOME = Special.MAIN_1_B_DEMON_HOME;
	Special MAIN_1_C_WOLFS_DEN = Special.MAIN_1_C_WOLFS_DEN;
	Special MAIN_1_D_SLAVERY = Special.MAIN_1_D_SLAVERY;
	Special MAIN_1_E_REPORT_TO_HELENA = Special.MAIN_1_E_REPORT_TO_HELENA;
	Special MAIN_1_F_SCARLETTS_FATE = Special.MAIN_1_F_SCARLETTS_FATE;
	Special MAIN_1_G_SLAVERY = Special.MAIN_1_G_SLAVERY;
	Special MAIN_1_H_THE_GREAT_ESCAPE = Special.MAIN_1_H_THE_GREAT_ESCAPE;
	Special MAIN_1_I_ARTHURS_TALE = Special.MAIN_1_I_ARTHURS_TALE;
	Special MAIN_1_J_ARTHURS_ROOM = Special.MAIN_1_J_ARTHURS_ROOM;
	Special MAIN_2_A_INTO_THE_DEPTHS = Special.MAIN_2_A_INTO_THE_DEPTHS;
	Special MAIN_2_B_SIRENS_CALL = Special.MAIN_2_B_SIRENS_CALL;
	Special MAIN_2_C_SIRENS_FALL = Special.MAIN_2_C_SIRENS_FALL;
	Special MAIN_2_D_MEETING_A_LILIN = Special.MAIN_2_D_MEETING_A_LILIN;
	Special MAIN_3_ELIS = Special.MAIN_3_ELIS;
	Special MAIN_3_B_MEETING_MERAXIS = Special.MAIN_3_B_MEETING_MERAXIS;
	Special MAIN_3_C_MEETING_MINOTALLYS = Special.MAIN_3_C_MEETING_MINOTALLYS;
	Special MAIN_3_D_TO_THEMISCYRA = Special.MAIN_3_D_TO_THEMISCYRA;
	Special MAIN_3_E_TODO = Special.MAIN_3_E_TODO;
	Special SIDE_UTIL_COMPLETE = Special.SIDE_UTIL_COMPLETE;
	Special SIDE_DISCOVER_ALL_ITEMS = Special.SIDE_DISCOVER_ALL_ITEMS;
	Special SIDE_DISCOVER_ALL_RACES = Special.SIDE_DISCOVER_ALL_RACES;
	Special SIDE_ENCHANTMENTS_LILAYA_HELP = Special.SIDE_ENCHANTMENTS_LILAYA_HELP;
	Special SIDE_PREGNANCY_CONSULT_LILAYA = Special.SIDE_PREGNANCY_CONSULT_LILAYA;
	Special SIDE_PREGNANCY_LILAYA_THE_MIDWIFE = Special.SIDE_PREGNANCY_LILAYA_THE_MIDWIFE;
	Special SIDE_INCUBATION_WAITING = Special.SIDE_INCUBATION_WAITING;
	...
	Special HARPY_PACIFICATION_TWO = Special.HARPY_PACIFICATION_TWO;
	Special HARPY_PACIFICATION_THREE = Special.HARPY_PACIFICATION_THREE;
	Special HARPY_PACIFICATION_REWARD = Special.HARPY_PACIFICATION_REWARD;
	Special SLIME_QUEEN_ONE = Special.SLIME_QUEEN_ONE;
	Special SLIME_QUEEN_TWO = Special.SLIME_QUEEN_TWO;
	Special SLIME_QUEEN_THREE = Special.SLIME_QUEEN_THREE;
	Special SLIME_QUEEN_FOUR = Special.SLIME_QUEEN_FOUR;
	Special SLIME_QUEEN_FIVE_SUBMIT = Special.SLIME_QUEEN_FIVE_SUBMIT;
	Special SLIME_QUEEN_SIX_SUBMIT = Special.SLIME_QUEEN_SIX_SUBMIT;
	Special SLIME_QUEEN_FIVE_CONVINCE = Special.SLIME_QUEEN_FIVE_CONVINCE;
	Special SLIME_QUEEN_SIX_CONVINCE = Special.SLIME_QUEEN_SIX_CONVINCE;
	Special SLIME_QUEEN_FIVE_FORCE = Special.SLIME_QUEEN_FIVE_FORCE;
	Special SLIME_QUEEN_SIX_FORCE = Special.SLIME_QUEEN_SIX_FORCE;
	Special TELEPORTING_START = Special.TELEPORTING_START;
	Special TELEPORTING_CAUGHT = Special.TELEPORTING_CAUGHT;
	Special DADDY_START = Special.DADDY_START;
	Special DADDY_MEETING = Special.DADDY_MEETING;
	Special DADDY_REFUSED = Special.DADDY_REFUSED;
	Special DADDY_REFUSED_2 = Special.DADDY_REFUSED_2;
	Special DADDY_ACCEPTED = Special.DADDY_ACCEPTED;
	Special DADDY_LILAYA_MEETING = Special.DADDY_LILAYA_MEETING;
	Special BUYING_BRAX_START = Special.BUYING_BRAX_START;
	Special BUYING_BRAX_DELIVER_PERFUME = Special.BUYING_BRAX_DELIVER_PERFUME;
	Special BUYING_BRAX_LOLLIPOPS = Special.BUYING_BRAX_LOLLIPOPS;
	Special BUYING_BRAX_DELIVER_LOLLIPOPS = Special.BUYING_BRAX_DELIVER_LOLLIPOPS;
	Special BUYING_BRAX_LIPSTICK = Special.BUYING_BRAX_LIPSTICK;
	Special BUYING_BRAX_DELIVER_LIPSTICK = Special.BUYING_BRAX_DELIVER_LIPSTICK;
	Special VENGAR_START = Special.VENGAR_START;
	Special VENGAR_ONE = Special.VENGAR_ONE;
	Special VENGAR_TWO_CONFLICT = Special.VENGAR_TWO_CONFLICT;
	Special VENGAR_TWO_COOPERATION = Special.VENGAR_TWO_COOPERATION;
	Special VENGAR_TWO_ENFORCERS = Special.VENGAR_TWO_ENFORCERS;
	Special VENGAR_THREE_COOPERATION_END = Special.VENGAR_THREE_COOPERATION_END;
	Special VENGAR_THREE_END = Special.VENGAR_THREE_END;
	Special VENGAR_OPTIONAL_CLAIRE = Special.VENGAR_OPTIONAL_CLAIRE;
	Special WES_FAIL = Special.WES_FAIL;
	Special WES_START = Special.WES_START;
	Special WES_1 = Special.WES_1;
	Special WES_2 = Special.WES_2;
	Special WES_3_WES = Special.WES_3_WES;
	Special WES_3_ELLE = Special.WES_3_ELLE;
	Special REBEL_BASE_HANDLE_REFUSED = Special.REBEL_BASE_HANDLE_REFUSED;
	Special REBEL_BASE_PASSWORD_PART_ONE = Special.REBEL_BASE_PASSWORD_PART_ONE;
	Special REBEL_BASE_PASSWORD_PART_TWO = Special.REBEL_BASE_PASSWORD_PART_TWO;
	Special REBEL_BASE_PASSWORD_COMPLETE = Special.REBEL_BASE_PASSWORD_COMPLETE;
	Special REBEL_BASE_EXPLORATION = Special.REBEL_BASE_EXPLORATION;
	Special REBEL_BASE_ESCAPE = Special.REBEL_BASE_ESCAPE;
	Special REBEL_BASE_FAILED = Special.REBEL_BASE_FAILED;
	Special REBEL_BASE_FIREBOMBS_START = Special.REBEL_BASE_FIREBOMBS_START;
	Special REBEL_BASE_FIREBOMBS_FINISH = Special.REBEL_BASE_FIREBOMBS_FINISH;
	Special REBEL_BASE_FIREBOMBS_FAILED = Special.REBEL_BASE_FIREBOMBS_FAILED;
	Special RELATIONSHIP_NYAN_1_STOCK_ISSUES = Special.RELATIONSHIP_NYAN_1_STOCK_ISSUES;
	Special RELATIONSHIP_NYAN_2_STOCK_ISSUES_AGREED_TO_HELP = Special.RELATIONSHIP_NYAN_2_STOCK_ISSUES_AGREED_TO_HELP;
	Special RELATIONSHIP_NYAN_3_STOCK_ISSUES_DOBERMANNS = Special.RELATIONSHIP_NYAN_3_STOCK_ISSUES_DOBERMANNS;
	Special RELATIONSHIP_NYAN_4_STOCK_ISSUES_SUPPLIERS_BEATEN = Special.RELATIONSHIP_NYAN_4_STOCK_ISSUES_SUPPLIERS_BEATEN;
	Special ROMANCE_HELENA_FAILED = Special.ROMANCE_HELENA_FAILED;
	Special ROMANCE_HELENA_1_OFFER_HELP = Special.ROMANCE_HELENA_1_OFFER_HELP;
	Special ROMANCE_HELENA_2_PURCHASE_PAINT = Special.ROMANCE_HELENA_2_PURCHASE_PAINT;
	Special ROMANCE_HELENA_3_A_EXTERIOR_DECORATOR = Special.ROMANCE_HELENA_3_A_EXTERIOR_DECORATOR;
	Special ROMANCE_HELENA_3_B_EXTERIOR_DECORATOR = Special.ROMANCE_HELENA_3_B_EXTERIOR_DECORATOR;
	Special ROMANCE_HELENA_3_C_EXTERIOR_DECORATOR = Special.ROMANCE_HELENA_3_C_EXTERIOR_DECORATOR;
	Special ROMANCE_HELENA_4_SCARLETTS_RETURN = Special.ROMANCE_HELENA_4_SCARLETTS_RETURN;
	Special ROMANCE_HELENA_5_SCARLETT_TRAINER = Special.ROMANCE_HELENA_5_SCARLETT_TRAINER;
	Special ROMANCE_HELENA_6_ADVERTISING = Special.ROMANCE_HELENA_6_ADVERTISING;
	Special ROMANCE_HELENA_7_GRAND_OPENING_PREPARATION = Special.ROMANCE_HELENA_7_GRAND_OPENING_PREPARATION;
	Special ROMANCE_HELENA_8_FINISH = Special.ROMANCE_HELENA_8_FINISH;
	Special ROMANCE_NATALYA_FAILED_INTERVIEW = Special.ROMANCE_NATALYA_FAILED_INTERVIEW;
	Special ROMANCE_NATALYA_FAILED_CONTRACT = Special.ROMANCE_NATALYA_FAILED_CONTRACT;
	Special ROMANCE_NATALYA_1_INTERVIEW_START = Special.ROMANCE_NATALYA_1_INTERVIEW_START;
	Special ROMANCE_NATALYA_2_CONTRACT_SIGNED = Special.ROMANCE_NATALYA_2_CONTRACT_SIGNED;
	Special ROMANCE_NATALYA_3_TRAINING_1 = Special.ROMANCE_NATALYA_3_TRAINING_1;
	Special ROMANCE_NATALYA_4_TRAINING_2 = Special.ROMANCE_NATALYA_4_TRAINING_2;
	Special ROMANCE_NATALYA_5_TRAINING_3 = Special.ROMANCE_NATALYA_5_TRAINING_3;
	Special ROMANCE_MONICA_1_TO_THE_FARM = Special.ROMANCE_MONICA_1_TO_THE_FARM;
	Special ROMANCE_MONICA_2_UNREASONABLE_DEMAND = Special.ROMANCE_MONICA_2_UNREASONABLE_DEMAND;
	Special ROMANCE_MONICA_3_THE_JOURNEY_HOME = Special.ROMANCE_MONICA_3_THE_JOURNEY_HOME;

	Table<Quest> table = new Table<>(Quest::sanitize){{
	...
	public static Quest getQuestFromId(String quest) {
		return table.of(quest);
	}

	private static String sanitize(String id) {
		switch(id.toUpperCase()) {
		case "MAIN_3_A_FINDING_THE_YOUKO":
			return "MAIN_3_ELIS";
		case "MAIN_3_D_TO_THEMISCRYA":
